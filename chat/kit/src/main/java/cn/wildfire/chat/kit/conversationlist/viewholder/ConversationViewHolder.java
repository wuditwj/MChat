...
import cn.wildfire.chat.app.sysmessage.PaySupport;
import cn.wildfire.chat.app.sysmessage.SystemBotMessage;
...
public abstract class ConversationViewHolder extends RecyclerView.ViewHolder {
    ...
    public void onBind(ConversationInfo conversationInfo) {
        ...
        itemView.setBackgroundResource(conversationInfo.isTop ? R.drawable.selector_stick_top_item : R.drawable.selector_common_item_1);
    ...
    public void onClick(View itemView) {
        ...
        if (conversationInfo.conversation.target.equals("admin")) {
            //支付小助手
            Intent intent = new Intent(fragment.getActivity(), PaySupport.class);
            fragment.startActivity(intent);
        } else if (conversationInfo.conversation.target.equals("FireRobot")) {
            //系统消息
            Intent intent = new Intent(fragment.getActivity(), SystemBotMessage.class);
            fragment.startActivity(intent);
