...
public interface MessageContentType {
    ...
    int ContentType_RedPackage =1009;//红包

    int MESSAGE_CONTENT_TYPE_FINGER= 1010;//猜拳

    int MESSAGE_CONTENT_TYPE_CARD=1011;//名片

    int ContentType_RED_ENVELOPE_STATUS = 1081;//红包被领取消息类型

    int ContentType_SHAKE_STATUS = 1082;//抖动消息类型
}
